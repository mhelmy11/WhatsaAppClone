        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowReadReceipts = table.Column<bool>(type: "bit", nullable: false),
                    WhoCanSeeMyStory = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WhoCanAddMeToGroups = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WhoCanSeeMyLastSeen = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WhoCanViewProfilePic = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AllowMessagesForMembers = table.Column<bool>(type: "bit", nullable: false),
                    ApprovalRequiredToJoin = table.Column<bool>(type: "bit", nullable: false),
                    EditGroupDescription = table.Column<bool>(type: "bit", nullable: false),
                    IsCommunity = table.Column<bool>(type: "bit", nullable: false),
                    CommunityId = table.Column<long>(type: "bigint", nullable: true),
                    InviteLink = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    InviteLinkExpiry = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RefreshTokenAudits_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupJoinRequests", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_GroupJoinRequests_AspNetUsers_ProcessedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupJoinRequests_ProcessedBy",
                table: "GroupJoinRequests",
                column: "ProcessedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokenAudits_ExpiresAt",
                table: "RefreshTokenAudits",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokenAudits_IsRevoked",
                table: "RefreshTokenAudits",
                column: "IsRevoked");

            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokenAudits_Token",
                table: "RefreshTokenAudits",
                column: "Token",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokenAudits_UserId",
                table: "RefreshTokenAudits",
                column: "UserId");
        }
